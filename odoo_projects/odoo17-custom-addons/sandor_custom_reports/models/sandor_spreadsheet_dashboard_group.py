...
class SandorSpreadsheetDashboardGroup(models.Model):
    _name = 'sandor.spreadsheet.dashboard.group'
    _description = 'Sandor Group of dashboards'
    _order = 'sequence'

    name = fields.Char(required=True, translate=True)
    dashboard_ids = fields.One2many('sandor.spreadsheet.dashboard', 'dashboard_group_id')

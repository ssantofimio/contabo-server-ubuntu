...
class InventoryOverStockReport(models.TransientModel):
    ...
    inventory_for_next_x_days = fields.Integer(
        ...
        help="Seleccione el número de días próximos para el inventario")
    ...
    def get_xlsx_report(self, data, response):
        ...
        if start_date and end_date:
            ...
            sheet.write('A6',  'Histórico de Ventas hasta: ', bold_format)
        ...
        headers = ['Producto', 'Categoría', 'Stock Actual', 'Incoming',
                   'Outgoing', 'Virtual Stock', 'Ventas', 'ADS', 'Demanded QTY',
                   'Coverage Days', 'Over Stock QTY', 'Over Stock QTY(%)',
                   'Over Stock Value', 'Over Stock Value(%)', 'Rotación',
                   'Clasificación FSN', 'Last PO Date', 'Last PO QTY',
